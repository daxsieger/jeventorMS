...
public class EventoResource {
    ...
    @GetMapping("/eventos")
    @Timed
    public ResponseEntity<List<Evento>> getAllEventos(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/eventos?eagerload=%b", eagerload));
